    ...
    <div>
      ...
      <div className="space-y-3 sm:space-y-4">
        {members.map((m) => (
          <div
            key={m.num}
            className="p-3.5 sm:p-5 rounded-[4px] bg-[#191220] border border-[#362844] hover:border-[#3E2F4E] transition-colors"
          >
            <div className="flex items-center space-x-2 mb-3 sm:mb-4">
              <span className="text-[10px] sm:text-[11px] font-mono font-bold px-1.5 py-0.5 rounded-[2px] bg-[#C8F04A] text-[#17121C]">
                0{m.num}
              </span>
              <h3 className="text-[11px] sm:text-xs font-mono font-bold text-[#FFFDF7] uppercase tracking-wider">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {/* Member Name */}
              <div>
                <label className="block text-[11px] sm:text-xs font-mono font-bold text-[#FFFDF7] uppercase tracking-wider mb-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`dark-editorial-input w-full pl-9 pr-3 py-2 sm:py-2.5 text-sm text-[#FFFDF7] placeholder-[#786882] ${
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`dark-editorial-input w-full pl-9 pr-3 py-2 sm:py-2.5 text-sm text-[#FFFDF7] placeholder-[#786882] uppercase ${
